...
/**
 * This class represents a POJO based {@code LinkResultPageResource}. <br/><br/>
 * 
 ...
 */
public final class LinkResultPageResource implements ResultPageResource
{
	private HyperLinkResourceWrapper page;
	private ArrayList<DocumentLinkResource> list;
	...
	public ArrayList<DocumentLinkResource> getList()
	{
		return list;
	}

	public void setList(ArrayList<DocumentLinkResource> list)
	{
		this.list = list;
	}

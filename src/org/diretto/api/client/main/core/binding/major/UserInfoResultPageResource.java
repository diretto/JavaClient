...
/**
 * This class represents a POJO based {@code UserInfoResultPageResource}.
 * <br/><br/>
 * 
 ...
 */
public final class UserInfoResultPageResource implements ResultPageResource
{
	private HyperLinkResourceWrapper page;
	private ArrayList<UserInfoResource> list;
	...
	public ArrayList<UserInfoResource> getList()
	{
		return list;
	}

	public void setList(ArrayList<UserInfoResource> list)
	{
		this.list = list;
	}

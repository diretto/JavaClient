...
/**
 * This class represents a POJO based {@code MessageResultPageResource}.
 * <br/><br/>
 * 
 ...
 */
public final class MessageResultPageResource implements ResultPageResource
{
	private HyperLinkResourceWrapper page;
	private ArrayList<MessageReceptionResource> list;
	...
	public ArrayList<MessageReceptionResource> getList()
	{
		return list;
	}

	public void setList(ArrayList<MessageReceptionResource> list)
	{
		this.list = list;
	}
